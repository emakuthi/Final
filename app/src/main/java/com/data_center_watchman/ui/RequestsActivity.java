...
public class RequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<Visitor>>() {
            ...
            public void onFailure(Call<List<Visitor>> call, Throwable t) {
                Toast.makeText(RequestsActivity.this, "Something went wrong......try again", Toast.LENGTH_SHORT).show();
    ...
    public boolean isOnline() {
        ...
        if(netInfo == null || !netInfo.isConnected() || !netInfo.isAvailable()){
            Toast.makeText(RequestsActivity.this, "No Internet connection!", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
